...
public class SchemaCodeGenerator(string rootPath, string rootNamespace, string jsonConverterNamespace, string[] jsonConverterNames)
{
    ...
    private CompilationUnitSyntax CreateCodeFromClass(SchemaClass type)
    {
        ...
        schemaNamespace = AddAutoGeneratedHeader(schemaNamespace);
        ...
        string className, string ns)
    {
        ...
        contextNamespace = AddAutoGeneratedHeader(contextNamespace);
    ...
    /// <summary>
    /// Adds a comment to the file to indicate this file was generated and adds preprocessing parameters to avoid warning.
    /// </summary>
    /// <param name="syntaxNode">The node to add the comment.</param>
    /// <typeparam name="TSyntax">The syntax node type.</typeparam>
    /// <returns>Returns the modified syntax node.</returns>
    private static TSyntax AddAutoGeneratedHeader<TSyntax>(TSyntax syntaxNode) where TSyntax : SyntaxNode
    {
        ...
        return syntaxNode
            .WithLeadingTrivia(SyntaxFactory.TriviaList(
                ...
                SyntaxFactory.CarriageReturnLineFeed,
                SyntaxFactory.PreprocessingMessage("#pragma warning disable CS1591"),
                SyntaxFactory.CarriageReturnLineFeed));
    }
